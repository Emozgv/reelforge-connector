  ...
  return (
    <div className="flex flex-col items-center">
      <div
        ...
        className="relative w-[360px] h-[min(76vh,660px)] rounded-2xl overflow-hidden border border-[#D39448]/20 shadow-[0_24px_64px_-20px_rgba(0,0,0,0.8),0_0_0_1px_rgba(211,148,72,0.06),0_0_32px_-8px_rgba(211,148,72,0.12)]"
      >
        {currentReel ? (
          <SwipeSlide
            key={currentReel.id}
